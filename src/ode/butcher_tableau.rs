...
/// Structure containing the coefficients for the Dormand-Prince method of order 5(4) with dense outputs of order 4.
...
/// Structure containing the coefficients for the Dormand-Prince method of order 8(5,3) with dense outputs of order 7.
...
impl Dopri853 {
    ...
    pub fn new() -> Dopri853 {
        Dopri853 {
            ...
            order: 7,
            a: vec![
                vec![5.26001519587677318785587544488E-2],
                vec![
