...
pub fn ellip_gridder(
    ndiv: u32,
    req: f64,
    shape: &Vector3<f64>,
    centre: &Vector3<f64>,
    orient: &na::UnitQuaternion<f64>,
...
pub fn combiner_splitter(
    nelm1: usize,
    nelm2: usize,
    npts1: usize,
    npts2: usize,
    n_line_1: &DMatrix<usize>,
    n_line_2: &DMatrix<usize>,
    sing_elms_1: &Vec<usize>,
    sing_elms_2: &Vec<usize>,
    nonsing_elms_1: &Vec<usize>,
    nonsing_elms_2: &Vec<usize>,
) -> (usize, usize, DMatrix<usize>, Vec<usize>, Vec<usize>) {
    let nelm = nelm1 + nelm2;
    let npts = npts1 + npts2;
...
pub fn elm_geom(
    ...
    for k in 0..nelm {
        ...
        for i in 0..mint {
            ...
            let (xvec, vn, hs) = interp_p(p1, p2, p3, p4, p5, p6, al, be, ga, xi, eta);
        ...
        for i in 0..6 {
            ...
            let (_xvec, vn, _hs) = interp_p(p1, p2, p3, p4, p5, p6, al, be, ga, xi, eta);
