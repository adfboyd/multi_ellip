...
PACKED_SLURM="${ME_DIR}/studies/two_body_parameter_sweep/archer2_packed_w_lapack.slurm"
...
echo "  squeue -u \$USER"
echo "  tail -f ${ME_DIR}/studies/two_body_parameter_sweep/archer2_packed_progress.log"
...
echo
echo "Useful options:"
echo "  QOS=short WALLTIME=00:20:00 MAX_CASES=32 ${0}"
